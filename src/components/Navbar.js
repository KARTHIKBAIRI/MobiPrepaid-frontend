        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm sticky-top">
            <div className="container">
                <Link className="navbar-brand fw-bold d-flex align-items-center" to="/">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-phone-fill me-2" viewBox="0 0 16 16">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ms-auto">
                        {/* <li className="nav-item">
                            <Link className="nav-link" to="/" style={{ color: '#fff', opacity: 1 }}>
                        ...
                        {!user ? (
                            <>
                                <li className="nav-item">
                                    <Link className="nav-link" to="/validate" style={{ color: '#fff', opacity: 1 }}>
                            ...
                            <>
                                <li className="nav-item">
                                    <Link className="nav-link" to="/admin/dashboard" style={{ color: '#fff', opacity: 1 }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-speedometer2 me-1" viewBox="0 0 16 16">
                                ...
                                <li className="nav-item dropdown">
                                    {/* Fixed: Replaced <a> with <button> for the dropdown toggle */}
                                    <button 
